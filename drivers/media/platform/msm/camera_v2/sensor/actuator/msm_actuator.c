...
static struct msm_actuator_ctrl_t pub_a_ctrl;
static int pub_a_ctrl_is_init = 0;
uint16_t c4_c5_last = 0,reg_c4_c5 = 0;
struct msm_camera_i2c_reg_array dw9714_i2c_tbl[1];
struct msm_camera_i2c_reg_array bu6424_i2c_tbl[1];
...
/* [PLATFORM]-Mod-END by TCTNB.YJ*/
		...
		if(i2c_byte1 == 0xc4){
			c4_c5_last = i2c_byte2;
			reg_c4_c5 = 0xc4;
		}
		else if(i2c_byte1 == 0xc5){
			c4_c5_last = i2c_byte2;
			reg_c4_c5 = 0xc5;
		}
...
/*[PLATFORM]-Add-BEGIN by TCTNBYQJ, FR-844467, 2014/12/11 */
int bu6424_close(void) {
	struct msm_camera_i2c_reg_setting reg_setting;
	int rc = 0;

	CDBG("Enter\n");
	if (!pub_a_ctrl_is_init) {
		pr_err("actuator can't close\n");
		return -EINVAL;
	} 
	if(reg_c4_c5 == 0 || c4_c5_last == 0)
		return 0;
	
	if(reg_c4_c5 == 0xc5){
		while(c4_c5_last > 0x10 && c4_c5_last <= 0xff)
    	{
    		//printk("~~~c5_last = %x \n",c4_c5_last);
			bu6424_i2c_tbl[0].reg_addr = 0xc5;
			bu6424_i2c_tbl[0].reg_data = c4_c5_last;
			bu6424_i2c_tbl[0].delay = 15000;
			reg_setting.reg_setting = bu6424_i2c_tbl;
			reg_setting.data_type = MSM_ACTUATOR_BYTE_DATA;
			reg_setting.size = 1;
			rc = pub_a_ctrl.i2c_client.i2c_func_tbl->i2c_write_table_w_microdelay(
			&(pub_a_ctrl.i2c_client), &reg_setting);
			c4_c5_last -=0x10;
		}
	
		c4_c5_last = 0xf0 | (c4_c5_last&0xf);
	}
    while(c4_c5_last > 0x10 && c4_c5_last <= 0xff)
    {
    	//printk("~~~c4_last = %x \n",c4_c5_last);
		bu6424_i2c_tbl[0].reg_addr = 0xc4;
		bu6424_i2c_tbl[0].reg_data = c4_c5_last;
		bu6424_i2c_tbl[0].delay = 15000;
	...
	bu6424_i2c_tbl[0].reg_addr = 0xc4;
	bu6424_i2c_tbl[0].reg_data = 0x00;
	bu6424_i2c_tbl[0].delay = 15000;
...
int dw9714_close(void) {
	...
	dw9714_i2c_tbl[0].reg_addr = 0x07;
	dw9714_i2c_tbl[0].reg_data = 0x67;
	dw9714_i2c_tbl[0].delay = 15000;

	reg_setting.reg_setting = dw9714_i2c_tbl;
	reg_setting.data_type = MSM_ACTUATOR_BYTE_DATA;
	reg_setting.size = 1;
	rc = pub_a_ctrl.i2c_client.i2c_func_tbl->i2c_write_table_w_microdelay(
		&(pub_a_ctrl.i2c_client), &reg_setting);
