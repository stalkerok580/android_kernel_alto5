...
#if (!defined(CONFIG_TCT_8X16_ALTO45_LATAM_B28) || !defined(CONFIG_TCT_8X16_ALTO5) || !defined(CONFIG_TCT_8X16_ALTO4))
	/*
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YJ, add for rear camera on idol3  */
	...
	*/
#if defined(CONFIG_TCT_8X16_IDOL3) || defined(CONFIG_TCT_8X16_IDOL347)
	if ( 0 == strncmp(s_ctrl->sensordata->actuator_name, "ak7345", strlen("ak7345")) ) {
