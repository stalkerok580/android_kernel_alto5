...
/* [PLATFORM]-Mod-BEGIN by TCTNB.YQJ, 2014/12/27, PR-862880 ptp device display as mtp device because it is mtp ctrrequest,so delete it as before */
#if 0
...
#endif
/* [PLATFORM]-Mod-END by TCTNB.YQJ, 2014/12/27 */
