...
/*TCTNB THW add  for PR.898089 20150111*/
...
#if (defined CONFIG_TCT_8X16_ALTO5 || defined CONFIG_TCT_8X16_ALTO5_PREMIUM)
//TCTNB THW remove code for PR.898089 20150111
#else
	if (ctrl->pwm_enabled) {
		pwm_disable(ctrl->pwm_bl);
		ctrl->pwm_enabled = 0;
...
#endif
/*TCTNB THW modify for PR.898089 20150111*/
#if (defined CONFIG_TCT_8X16_ALTO5 || defined CONFIG_TCT_8X16_ALTO5_PREMIUM)
	if (!ctrl->pwm_enabled) {
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.CY, PR-895579, 2015/2/4, remove esd check in MMI */
#if (defined FEATURE_TCTNB_MMITEST && defined CONFIG_TCT_8X16_ALTO4)/*disable esd check in MMI*/
	pinfo->esd_check_enabled = false;
#endif
/*[PLATFORM]-Mod-END by TCTNB.CY, 2015/2/4*/
