...
/* [PLATFORM]-Mod-BEGIN by TCTNB.HJ, 2015/01/28*/
#if defined (CONFIG_TCT_8X16_ALTO4)
extern int alto4_boost_enable;
#endif
/* [PLATFORM]-Mod-BEGIN by TCTNB.HJ, 2015/01/28*/
				...
				struct snd_ctl_elem_value *ucontrol)
{
    ...
    /* [PLATFORM]-Mod-BEGIN by TCTNB.HJ, 2015/01/28*/
#if defined (CONFIG_TCT_8X16_ALTO4)
    if(alto4_boost_enable == 0){
        pr_debug("hujin i set it false\n");
        msm8x16_wcd->ear_pa_boost_set = false;
    }
#endif
/* [PLATFORM]-Mod-END by TCTNB.HJ, 2015/01/28*/
...
/* [PLATFORM]-Mod-BEGIN by TCTNB.HJ, 2014/12/06*/
#if defined(CONFIG_TCT_8X16_ALTO45_LATAM_B28) || defined(CONFIG_TCT_8X16_ALTO4)
	{"MIC BIAS Internal3", NULL, "INT_LDO_H"},
#endif
/* [PLATFORM]-Mod-BEGIN by TCTNB.HJ*/
